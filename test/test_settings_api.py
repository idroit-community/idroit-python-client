...
class TestSettingsApi(unittest.TestCase):
    ...
    def test_settings_controller_find_all(self):
        """Test case for settings_controller_find_all

        Get all admins  # noqa: E501
        """
        pass

    def test_settings_controller_find_one(self):
        """Test case for settings_controller_find_one
