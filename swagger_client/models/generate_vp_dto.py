...
class GenerateVpDto(object):
    ...
    def __init__(self, did_info_id=None):  # noqa: E501
        """GenerateVpDto - a model defined in Swagger"""  # noqa: E501
    ...
    def did_info_id(self):
        """Gets the did_info_id of this GenerateVpDto.  # noqa: E501

        (必須) VPを生成する際にVCに対しての署名に用いるDIDの識別子  # noqa: E501

        :return: The did_info_id of this GenerateVpDto.  # noqa: E501
        :rtype: str
        """
    ...
    def did_info_id(self, did_info_id):
        """Sets the did_info_id of this GenerateVpDto.

        (必須) VPを生成する際にVCに対しての署名に用いるDIDの識別子  # noqa: E501

        :param did_info_id: The did_info_id of this GenerateVpDto.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GenerateVpDto, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GenerateVpDto):
            return False
