...
class Group(object):
    ...
    swagger_types = {
        ...
        'description': 'str',
        'users': 'list[User]',
        'created_by': 'AllOfGroupCreatedBy',
    ...
    def status(self):
        ...
        (必須) グループの状態(1: アクティブ, 0: 停止中)  # noqa: E501
    ...
    def users(self):
        ...
        (任意) グループに紐付いたアカウントの配列  # noqa: E501
    ...
    def created_by(self):
        ...
        (必須) グループを作成したユーザーアカウント。  # noqa: E501

        :return: The created_by of this Group.  # noqa: E501
        :rtype: AllOfGroupCreatedBy
        """
    ...
    @property
    def did_infos(self):
        """Gets the did_infos of this Group.  # noqa: E501

        (任意) グループに紐付いたDID情報の配列  # noqa: E501

        :return: The did_infos of this Group.  # noqa: E501
        :rtype: list[DidInfo]
        """
    ...
    def did_infos(self, did_infos):
        """Sets the did_infos of this Group.

        (任意) グループに紐付いたDID情報の配列  # noqa: E501

        :param did_infos: The did_infos of this Group.  # noqa: E501
        :type: list[DidInfo]
        """
    ...
    @property
    def vc_infos(self):
        """Gets the vc_infos of this Group.  # noqa: E501

        (任意) グループに紐付いたVC情報の配列  # noqa: E501

        :return: The vc_infos of this Group.  # noqa: E501
        :rtype: list[VcInfo]
        """
    ...
    def vc_infos(self, vc_infos):
        """Sets the vc_infos of this Group.

        (任意) グループに紐付いたVC情報の配列  # noqa: E501

        :param vc_infos: The vc_infos of this Group.  # noqa: E501
        :type: list[VcInfo]
        """
    ...
    @property
    def vp_infos(self):
        """Gets the vp_infos of this Group.  # noqa: E501

        (任意) グループに紐付いたVP情報の配列  # noqa: E501

        :return: The vp_infos of this Group.  # noqa: E501
        :rtype: list[VpInfo]
        """
    ...
    def vp_infos(self, vp_infos):
        """Sets the vp_infos of this Group.

        (任意) グループに紐付いたVP情報の配列  # noqa: E501

        :param vp_infos: The vp_infos of this Group.  # noqa: E501
        :type: list[VpInfo]
        """
    ...
    @property
    def vc_schemas(self):
        """Gets the vc_schemas of this Group.  # noqa: E501

        (任意) グループに紐付いたVCスキーマの配列  # noqa: E501

        :return: The vc_schemas of this Group.  # noqa: E501
        :rtype: list[VcSchema]
        """
    ...
    def vc_schemas(self, vc_schemas):
        """Sets the vc_schemas of this Group.

        (任意) グループに紐付いたVCスキーマの配列  # noqa: E501

        :param vc_schemas: The vc_schemas of this Group.  # noqa: E501
        :type: list[VcSchema]
        """
